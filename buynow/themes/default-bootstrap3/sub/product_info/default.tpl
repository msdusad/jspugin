{if (isset($quantity_discounts) && count($quantity_discounts) > 0)}
	...
	<section class="page-product-box">
		<h3 class="page-subheading"><span class="title">{l s='Volume discounts'}</span></h3>
	...
	<!-- Data sheet -->
	<section class="page-product-box">
		<h3 class="page-subheading"><span class="title">{l s='Data sheet'}</span></h3>
...
{/if}
	...
	<!-- More info -->
	<section class="page-product-box">
		<h3 class="page-subheading"><span class="title">{l s='More info'}</span></h3>
			<!-- full description -->
...
{if isset($accessories) && $accessories}
	<!--Accessories -->
	<section class="page-product-box">
		<h3 class="page-subheading"><span class="title">{l s='Accessories'}</span></h3>
...
{if (isset($product) && $product->description) || (isset($features) && $features) || (isset($accessories) && $accessories) || (isset($HOOK_PRODUCT_TAB) && $HOOK_PRODUCT_TAB) || (isset($attachments) && $attachments) || isset($product) && $product->customizable}
	...
	<!--Download -->
	<section class="page-product-box">
		<h3 class="page-subheading"><span class="title">{l s='Download'}</span></h3>
	...
	<!--Customization -->
	<section class="page-product-box">
		<h3 class="page-subheading"><span class="title">{l s='Product customization'}</span></h3>
