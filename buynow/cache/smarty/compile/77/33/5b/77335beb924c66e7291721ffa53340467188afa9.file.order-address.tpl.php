<?php /* Smarty version Smarty-3.1.19, created on 2015-12-11 04:41:54
         compiled from "/home/easy2/public_html/buynow/themes/default-bootstrap/order-address.tpl" */ ?>
<?php /*%%SmartyHeaderCode:45829873566a54122f8d99-77689538%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '77335beb924c66e7291721ffa53340467188afa9' => 
    array (
      0 => '/home/easy2/public_html/buynow/themes/default-bootstrap/order-address.tpl',
      1 => 1448586598,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '45829873566a54122f8d99-77689538',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_566a54124c8066_86058045',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_566a54124c8066_86058045')) {function content_566a54124c8066_86058045($_smarty_tpl) {?>
...
"<?php if ($_smarty_tpl->tpl_vars['addresses']->value[$_smarty_tpl->getVariable('smarty')->value['section']['address']['index']]['id_address']==$_smarty_tpl->tpl_vars['cart']->value->id_address_invoice&&$_smarty_tpl->tpl_vars['cart']->value->id_address_delivery!=$_smarty_tpl->tpl_vars['cart']->value->id_address_invoice) {?> selected="selected"<?php }?>>
				...
				<?php } else { ?>
					<a href="<?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['back']->value) {?><?php echo "&mod=";?><?php echo (string)$_smarty_tpl->tpl_vars['back']->value;?><?php }?><?php $_tmp16=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true,null,"back=".((string)$_smarty_tpl->tpl_vars['back_order_page']->value)."?step=1&select_address=1".$_tmp16), ENT_QUOTES, 'UTF-8', true);?>
...
" />
				<a href="<?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['back']->value) {?><?php echo "back=";?><?php echo (string)$_smarty_tpl->tpl_vars['back']->value;?><?php }?><?php $_tmp18=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink($_smarty_tpl->tpl_vars['back_order_page']->value,true,null,$_tmp18), ENT_QUOTES, 'UTF-8', true);?>
