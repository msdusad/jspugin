<?php /* Smarty version Smarty-3.1.19, created on 2015-12-11 04:41:57
         compiled from "/home/easy2/public_html/buynow/themes/default-bootstrap/shopping-cart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2066669089566a5415aaecf4-79268444%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '84ad8ea6bd6dde9211e5422adfd4fadd85ba0a93' => 
    array (
      0 => '/home/easy2/public_html/buynow/themes/default-bootstrap/shopping-cart.tpl',
      1 => 1448586598,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2066669089566a5415aaecf4-79268444',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_566a541647e5f0_37718790',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_566a541647e5f0_37718790')) {function content_566a541647e5f0_37718790($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_regex_replace')) include '/home/easy2/public_html/buynow/tools/smarty/plugins/modifier.regex_replace.php';
?>
...
">
	...
	<?php }?>
	<?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['total_discounts']->value!=0) {?><?php echo "1";?><?php } else { ?><?php echo "0";?><?php }?><?php $_tmp37=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['total_discounts_num'] = new Smarty_variable($_tmp37, null, 0);?>
	<?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['use_taxes']->value&&$_smarty_tpl->tpl_vars['show_taxes']->value) {?><?php echo "2";?><?php } else { ?><?php echo "0";?><?php }?><?php $_tmp38=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['use_show_taxes'] = new Smarty_variable($_tmp38, null, 0);?>
	<?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['total_wrapping']->value!=0) {?><?php echo "1";?><?php } else { ?><?php echo "0";?><?php }?><?php $_tmp39=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['total_wrapping_taxes_num'] = new Smarty_variable($_tmp39, null, 0);?>
...
<?php $_tmp45=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&amp;id_product=".$_tmp44."&amp;ipa=".$_tmp45."&amp;id_customization=".((string)$_smarty_tpl->tpl_vars['id_customization']->value)."&amp;id_address_delivery=".((string)$_smarty_tpl->tpl_vars['product']->value['id_address_delivery'])."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)), ENT_QUOTES, 'UTF-8', true);?>
"
											rel="nofollow"
